...
export const benchmarkSources: BenchmarkSource[] = [
  { id: "melvynx-benchmarks", repo: "Melvynx/benchmarks", branch: "main", adapter: "melvynx", enabled: true, allowlist: ["transcripts.json", "runs/**/data/**/metadata.json", "benchmarks/**/index.html", "benchmarks/**/dist/index.html"] },
